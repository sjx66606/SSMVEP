...
save_name = 'conformer_res4_b' + str(batch_size) + '_c' + str(len(data_x[0])) + '.csv'
while save_name in os.listdir('/root/autodl-tmp/SSVEP/code/res/'):
    save_name = 'conformer_res4_b' + str(batch_size) + '_c' + str(len(data_x[0])) +'r' +str(np.random.randint(0,2024)) + '.csv'
